let heroData;_30e‍.x([["getHeroByIdCallback",()=>getHeroByIdCallback]]);_30e‍.w("./data",[["heroData",["heroData"],function(v){heroData=v}]]);
 ...
 */
  ...
  let h = heroicData.find(hero => hero.id == id);
...
getHeroByIdCallback(heroData, 2, (hero) => {
    _30e‍.g.console.log(`Found the hero with id ${hero.id}`, hero);
});
